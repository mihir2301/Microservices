...
func (x *ItemsWithQuantity) Reset() {
	*x = ItemsWithQuantity{}
	mi := &file_api_micro_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ItemsWithQuantity) Descriptor() ([]byte, []int) {
	return file_api_micro_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateOrderRequest) Reset() {
	*x = CreateOrderRequest{}
	mi := &file_api_micro_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateOrderRequest) Descriptor() ([]byte, []int) {
	return file_api_micro_proto_rawDescGZIP(), []int{3}
}
...
const file_api_micro_proto_rawDesc = "" +
	"\n" +
	"\x0fapi/micro.proto\x12\x03api\"p\n" +
	"\x05Order\x12\x0e\n" +
...
var (
	...
	file_api_micro_proto_rawDescData []byte
)

func file_api_micro_proto_rawDescGZIP() []byte {
	file_api_micro_proto_rawDescOnce.Do(func() {
		file_api_micro_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_micro_proto_rawDesc), len(file_api_micro_proto_rawDesc)))
	})
	return file_api_micro_proto_rawDescData
}

var file_api_micro_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_micro_proto_goTypes = []any{
...
func file_api_micro_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_micro_proto_rawDesc), len(file_api_micro_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
